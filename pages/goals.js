...
import ListGoals from '../components/ListGoals.js'
    ...
    <div className="row">
        <div className="col-12 mb-0 mt-4">
            ...
            <div className="row mx-auto mt-3 mb-5">
                {props.current.foundationStones.map((stone) => (
                    <div className="card col-sm-5 col-md-3 mb-2 mt-0 mr-2 p-0">
                        <p class="card-header">{stone.title}</p>
...
Page.getInitialProps = async function(context) {
    ...
    let currentGoal = Goals.filter(goal => goal.id === id)

    currentGoal.length === 1 ? currentGoal = currentGoal[0] : currentGoal = Goals[0];
